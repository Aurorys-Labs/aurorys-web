...
const ShieldNetwork = ({
	...
	return (
		<svg
			...
			className={cn(
				strokeColor || "stroke-cyan-200 dark:stroke-cyan-700",
				className,
			)}
			{...props}
		>
			<g id="Shielkd">
				<g id="Shield-shape">
					...
					<g id="Inner-Shield-Background">
						<path
							d="M341.532,74.833 c-29.811,25.056 -120.127,100.289 -276.461,107.42 c-30.958,408.288 190.687,519.118 276.479,562.082 c85.792,-42.964 307.437,-153.794 276.479,-562.082 c-156.334,-7.131 -246.65,-82.364 -276.461,-107.42 Z"
							fill="currentColor"
							fillOpacity="0.06"
							stroke="none"
						/>
